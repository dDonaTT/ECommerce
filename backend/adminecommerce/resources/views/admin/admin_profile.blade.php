...
<div class="container">
	<div class="main-body">
	 ...
	 <img src="{{ (!empty($adminData->profile_photo_path))?url('upload/admin_images/'.$adminData->profile_photo_path):url('upload/no-pictures.png')   }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
...
<div class="mb-3">
 <label for="formFile" class="form-label">Upload Profile Image</label>
	 ...
	 <div class="mb-3">
	 	...
	 	<img id="showImage" src="{{ (!empty($adminData->profile_photo_path))?url('upload/admin_images/'.$adminData->profile_photo_path):url('upload/no-pictures.png')   }}" style="width:100px; height: 100px;" >
